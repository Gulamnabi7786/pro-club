                ...
                <div className="about-one__content">
                  ...
                  >
                    ...
                    <h3 className="sec-title__title">
                      ...
                      <span className="sec-title__title__highlight">2016</span>
                    </h3>
                    {/* /.sec-title__title */}
                  </div>
                  {/* /.sec-title */}
                  ...
                  >
                    <p className="about-one__text">
                      The Programmer's Club at Saboo Siddik College of
                      Engineering fosters tech skills through hackathons,
                      workshops, and networking, creating a collaborative
                      community.
                    </p>
                  </div>
                    ...
                    >
                      ...
                      <div className="about-one__founder__info">
                        ...
                        <p className="about-one__founder__designation">
                          "The Only Thing That Stands Between You and Your Dream
                          is You."
                        </p>
                      </div>
              ...
              <div className="row gutter-y-30 align-items-center">
                <div className="col-lg-6">
                  ...
                  >
                    ...
                    <h3 className="sec-title__title">
                      {" "}
                      Events done by programmer's club
                      <br />
                    </h3>
                    {/* /.sec-title__title */}
                  </div>
                ...
                <div className="col-lg-6">
                  ...
                  >
                    <p className="services-one__text">
                      The Programmer's Club organizes hackathons, workshops,
                      coding competitions, guest lectures,project showcases,
                      networking events, and community service projects to
                      enhance technical skills and foster a collaborative
                      community of tech enthusiasts. Join us!
                    </p>
                    {/* /.services-one__text */}
                  </div>
              ...
              >
                <div className="service-card">
                  <div
                    ...
                    style={{
                      backgroundImage: "url(assets/images/events/error404.png)",
                    }}
                  />
                  {/* /.service-card__bg */}
                  ...
                  <div className="service-card__content">
                    ...
                    {/* /.service-card__title */}
                    <p className="service-card__text">2022-2023</p>
                    {/* /.service-card__text */}
                  </div>
              ...
              >
                <div className="service-card">
                  ...
                  <div className="service-card__content">
                    ...
                    {/* /.service-card__title */}
                    <p className="service-card__text">2022-2025</p>
                    {/* /.service-card__text */}
                  </div>
                  {/* /.service-card__content */}
                  <div className="service-card__image">
              ...
              >
                <div className="service-card">
                  ...
                  <div className="service-card__content">
                    ...
                    {/* /.service-card__title */}
                    <p className="service-card__text">2023-2024</p>
                    {/* /.service-card__text */}
                  </div>
                  {/* /.service-card__content */}
                  <div className="service-card__image">
            ...
            <div className="container">
              <div className="main-footer__bottom__inner">
                <p className="main-footer__copyright">
                  ...
                  <a href="https://devasil-portfolio.vercel.app/" color="white">
                    Asil
                  </a>{" "}
                  &{" "}
