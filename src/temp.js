                      ...
                      <div className="team-card__content">
                        <div className="team-card__content__inner">
                          ...
                          <p className="team-card__text">
                            Logged in users can view fuled social security
                            numbers and can see call.
                          </p>
                          {/* /.team-card__text */}
          ...
          <footer className="main-footer @@extraClassName">
            <div className="main-footer__top">
              <div
                ...
                style={{
                  backgroundImage:
                    "url(assets/images/backgrounds/footer-bg.jpg)",
                }}
              />
              {/* /.main-footer__bg */}
              <div className="container">
                  ...
                  >
                    <div className="footer-widget footer-widget--about">
                      ...
                      <p className="footer-widget__about">
                        ...
                        personalized approach digital marketing and get the
                        latest of update of our company.
                      </p>
